...
{
    if(nullptr==_peldany) _peldany = new Burgonya();
    return _peldany;
}
...
Borso* Borso::peldany()
{
    if(nullptr==_peldany) _peldany = new Borso();
    return _peldany;
}
...
{
    if(nullptr==_peldany) _peldany = new Hagyma();
    return _peldany;
}
...
Rozsa* Rozsa::peldany()
{
    if(nullptr==_peldany) _peldany = new Rozsa();
    return _peldany;
}
...
{
    if(nullptr==_peldany) _peldany = new Szegfu();
    return _peldany;
}
...
{
    if(nullptr==_peldany) _peldany = new Tulipan();
    return _peldany;
}
